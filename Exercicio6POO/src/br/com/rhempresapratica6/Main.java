...
public class Main {
	...
	public static void main(String[] args) {
		...
		qtdFunc = Integer.parseInt(JOptionPane.showInputDialog("Quantidade de Funcionario"));
		emp1 = new Empresa(nomeEmp, CNPJ, qtdFunc);
		for (Funcionario func1 : funcionarios) {
			emp1.insereFuncionario(func1);
			JOptionPane.showMessageDialog(null, func1.mostarDados(), "Mensagem", JOptionPane.DEFAULT_OPTION);
		}
